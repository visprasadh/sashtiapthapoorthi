(function () {
  var translations = {
    en: {
      ...
      body: 'as we celebrate this auspicious milestone with our family, friends and well-wishers.',
      detailsTitle: 'Ceremony Details',
      labelDate: 'Date',
      valueDate: 'Thursday, 11th June 2026',
      labelTime: 'Time',
    ...
    ta: {
      ...
      body: 'எங்கள் குடும்பம், நண்பர்கள் மற்றும் உறவினர்களுடன் இந்த சுப நிகழ்வைக் கொண்டாடும் வேளையில்',
      detailsTitle: 'விழா விவரங்கள்',
      labelDate: 'தேதி',
  ...
  if (calendarBtn) {
    calendarBtn.addEventListener('click', function () {
      ...
      var ics = [
        ...
        'LOCATION:Sri Oppiliappan Temple\\, Thirunageswaram\\, Tamil Nadu',
